...
class BotManager:
    ...
    price_list = "💲 Поездка: 1000 сум/км, минимум 6000 сум (3 км. включительно).\n💲  Доставка: 1000 сум/км, минимум 8000 сум (3 км. включительно).\n💲  Перегон: 1500 сум/км, минимум 25000 сум (3 км. включительно).\n💲 Ожидание: 360 сум/минуту. 5 минут бесплатно."
    ...
    def SendOffer(self,chat_id, car_type, car_number, arrival_time=None):
        ...
        if (current_call.type == "Предварительный Заказ"):
            self.bot.send_message(chat_id,
                                  "\n\n\n Ваш заказ оформлен,машина прибудет в указаное время!" + "\n➡️ Taxi Favorit диспетческая\n📞" +
                                  "2001010")
